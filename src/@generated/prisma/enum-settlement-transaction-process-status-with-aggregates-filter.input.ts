...
import { NestedEnumSettlementTransactionProcessStatusWithAggregatesFilter } from './nested-enum-settlement-transaction-process-status-with-aggregates-filter.input';
...
@InputType()
export class EnumSettlementTransactionProcessStatusWithAggregatesFilter {
