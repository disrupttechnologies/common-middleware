...
import { NestedEnumIncomingTxnStatusNullableWithAggregatesFilter } from './nested-enum-incoming-txn-status-nullable-with-aggregates-filter.input';
import { NestedIntNullableFilter } from './nested-int-nullable-filter.input';
import { NestedEnumIncomingTxnStatusNullableFilter } from './nested-enum-incoming-txn-status-nullable-filter.input';

@InputType()
export class EnumIncomingTxnStatusNullableWithAggregatesFilter {
