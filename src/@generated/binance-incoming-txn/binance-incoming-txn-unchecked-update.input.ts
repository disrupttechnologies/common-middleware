...
@InputType()
export class BinanceIncomingTxnUncheckedUpdateInput {
    ...
    @Field(() => WhitelabelIncomingTransactionUncheckedUpdateOneWithoutSettlementTransactionNestedInput, {nullable:true})
