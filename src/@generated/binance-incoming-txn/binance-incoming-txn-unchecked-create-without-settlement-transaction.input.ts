...
@InputType()
export class BinanceIncomingTxnUncheckedCreateWithoutSettlementTransactionInput {
  ...
  @Field(
    () =>
      WhitelabelIncomingTransactionUncheckedCreateNestedOneWithoutSettlementTransactionInput,
    { nullable: true },
  )
