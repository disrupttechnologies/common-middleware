...
@Resolver('SolHandler')
export class SOLhandlerResolver {
  ...
  constructor(
    private readonly btcIncomingTxnTrackerService: SOLIncomingTxnTrackerService,
    private readonly btcOrderManagerService: SOLOrderManagerService,
    private readonly config: ConfigService,
    private readonly prisma: PrismaService,
    private readonly dataService: SOLDataService,
  ) {
